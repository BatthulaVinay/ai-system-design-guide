...
| **Terminal-Bench 3.0** | 74 tasks across 7 domains, published August 7, 2026 to replace a saturated 2.1. Briefly cited at launch as "Frontier-Bench v0.1" before the rename | Active, built for headroom | The current discriminator for agentic terminal work. It more than doubles model separation versus 2.1, which is the whole reason it exists |
